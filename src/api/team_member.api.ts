...
export const updateUser = async (userId: number, userData: UpdateUserData): Promise<any> => {
  try {
...
// React Query hook for updating users
export const useUpdateUser = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      // Invalidate and refetch users list after successful update
      queryClient.invalidateQueries({ queryKey: ['users'] });
    },
    onError: (error) => {
